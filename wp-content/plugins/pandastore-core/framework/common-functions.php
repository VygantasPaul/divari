...
if ( ! function_exists( 'alpha_get_review_pagination' ) ) {
	...
	function alpha_get_review_pagination() {
		...
		$args = apply_filters(
			...
			array(
				'echo'      => false,
				'prev_text' => '<i class="' . ALPHA_ICON_PREFIX . '-icon-angle-left-solid"></i>' . esc_html__( 'Prev', 'pandastore-core' ),
				'next_text' => esc_html__( 'Next', 'pandastore-core' ) . '<i class="' . ALPHA_ICON_PREFIX . '-icon-angle-right-solid"></i>',
			)
		);
