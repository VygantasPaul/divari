...
class Alpha_Core_Custom_Image_Tag extends Elementor\Core\DynamicTags\Data_Tag {
	...
	public function get_title() {
		return esc_html__( 'Custom Image', 'pandastore-core' );
	}
	...
	public function register_advanced_section() {
		...
		$this->add_control(
			'fallback',
			array(
				'label' => esc_html__( 'Fallback', 'pandastore-core' ),
	...
	public function get_objects() {
		$objects = array(
			'featured'    => esc_html__( 'Featured Image', 'pandastore-core' ),
			'user_avatar' => esc_html__( 'User Avatar', 'pandastore-core' ),
		);
