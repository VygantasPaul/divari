...
if ( 'slider' == $layout_type ) { // render brands with swiper
		...
		<div class="brand-widget brand-widget-3">
			...
			<div class="brand-detail">
				...
				<div class="brand-info">
					...
					<span class="brand-product-count">(<?php echo esc_attr( count( $list->posts ) ) . esc_html__( ' Products', 'pandastore-core' ); ?> )</span>
					<?php
					if ( 'yes' == $show_brand_rating ) :
						?>
					<div class="ratings-container">
