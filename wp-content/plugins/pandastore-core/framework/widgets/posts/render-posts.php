...
extract( // @codingStandardsIgnoreLine
	shortcode_atts(
		array(
			...
			'items_list'                 => '',
			'loadmore_type'              => '',
			'loadmore_label'             => esc_html__( 'Load More', 'pandastore-core' ),

			// Post Type
			'follow_theme_option'        => '',
			'post_type'                  => 'default',
			'overlay'                    => '',
			'read_more_label'            => esc_html__( 'Read More', 'pandastore-core' ),
			'read_more_class'            => '',
			'excerpt_custom'             => '',
			'excerpt_length'             => 20,
			'excerpt_type'               => 'words',
...
if ( $posts->have_posts() ) {
	...
	if ( ! $follow_theme_option ) {
		...
		// $props['read_more_label'] = alpha_widget_button_get_label( $atts, '', $read_more_label ? $read_more_label : esc_html__( 'Read More', 'pandastore-core' ) );
