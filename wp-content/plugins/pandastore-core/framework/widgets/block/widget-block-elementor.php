...
class Alpha_Block_Elementor_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Block', 'pandastore-core' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_block',
			array(
				'label' => esc_html__( 'Block', 'pandastore-core' ),
			)
		);
			...
			$this->add_control(
				...
				array(
					...
					'description' => esc_html__( 'Choose your favourite block from pre-built blocks.', 'pandastore-core' ),
