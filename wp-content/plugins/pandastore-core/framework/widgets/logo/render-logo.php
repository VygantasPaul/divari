...
<a href="<?php echo esc_url( apply_filters( 'alpha_header_element_logo_url', home_url( '/' ) ) ); ?>" class="logo" title="<?php echo esc_attr( $site_title ); ?> - <?php bloginfo( 'description' ); ?>">
	<?php
	if ( $logo_id ) {
		...
		echo '<img class="site-logo skip-data-lazy" src="' . ALPHA_ASSETS . '/images/logo.png" width="144" height="45" alt="' . esc_attr( $site_title ) . '" title="' . esc_attr( $site_title ) . '"/>';
	}
	?>
</a>
