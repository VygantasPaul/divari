...
class Alpha_Svg_Floating_Elementor_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'SVG Floating', 'pandastore-core' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'float_content',
			array(
				'label' => esc_html__( 'SVG Floating', 'pandastore-core' ),
			)
		);
			...
			$this->add_control(
				'float_svg',
				array(
					'label'                  => esc_html__( 'Floating SVG', 'pandastore-core' ),
					'description'            => esc_html__( 'Please upload svg file to apply floating effect.', 'pandastore-core' ),
			...
			// 	array(
			// 		'description' => sprintf( esc_html__( '%1$s%2$sNote:%3$s This floating element is only for %2$sSVG%3$s files. And SVG file should have only %2$sPath%3$s elements.%4$s', 'pandastore-core' ), '<span class="important-note">', '<b>', '</b>', '</span>' ),
			// 		'type'        => 'alpha_description',
			// 	)
			// );
			...
			$this->add_control(
				'delta',
				array(
					'label'       => esc_html__( 'Offset', 'pandastore-core' ),
					'description' => esc_html__( 'Controls how much different SVG shape should be transformed.', 'pandastore-core' ),
			...
			$this->add_control(
				'speed',
				array(
					'label'       => esc_html__( 'Speed', 'pandastore-core' ),
					'description' => esc_html__( 'Controls how fast SVG shape should be transformed.', 'pandastore-core' ),
					'type'        => Controls_Manager::SLIDER,
				)
			);
			...
			$this->add_control(
				...
				array(
					...
					'description' => esc_html__( 'Controls size of SVG shape.', 'pandastore-core' ),
					'type'        => Controls_Manager::SLIDER,
					'range'       => array(
						'px' => array(
							'step' => 1,
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'rotate',
				array(
					'label'       => esc_html__( 'Rotate', 'pandastore-core' ),
					'description' => esc_html__( 'Controls how much SVG shape should be rotated.', 'pandastore-core' ),
					'type'        => Controls_Manager::SLIDER,
					'range'       => array(
						'px' => array(
							'step' => 1,
			...
			$this->add_control(
				'opacity',
				array(
					'label'       => esc_html__( 'Opacity', 'pandastore-core' ),
					'description' => esc_html__( 'Controls transparency of SVG shape.', 'pandastore-core' ),
					'type'        => Controls_Manager::SLIDER,
					'range'       => array(
						'px' => array(
							'step' => 0.1,
			...
			$this->add_control(
				...
				array(
					...
					'description' => esc_html__( 'Choose background color of SVG shape.', 'pandastore-core' ),
			...
			$this->add_control(
				...
				array(
					...
					'description' => esc_html__( 'Choose border color of SVG shape.', 'pandastore-core' ),
					'type'        => Controls_Manager::COLOR,
					'selectors'   => array(
