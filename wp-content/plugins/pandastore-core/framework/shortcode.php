...
add_shortcode( ALPHA_NAME . '_single_product', 'alpha_shortcode_single_product' );
...
function alpha_shortcode_single_product( $atts, $content = null ) {
	ob_start();
	require alpha_core_framework_path( ALPHA_CORE_FRAMEWORK_PATH . '/widgets/singleproducts/render-singleproducts.php', $atts );
	return ob_get_clean();
}
