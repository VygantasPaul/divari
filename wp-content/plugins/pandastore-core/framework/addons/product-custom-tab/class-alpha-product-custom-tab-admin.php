	...
	class Alpha_Product_Custom_Tab_Admin {
		...
		public function add_product_data_tab( $tabs ) {
			$tabs['alpha_custom_tabs'] = array(
				'label'    => esc_html__( 'Custom Description Tab ', 'pandastore-core' ),
			...
			<div id="alpha_custom_tab_options" class="panel woocommerce_options_panel wc-metaboxes-wrapper hidden">
				<div class="options_group" style="padding-bottom: 9px !important">
					...
					<div class="form-field alpha_custom_tab_content_field">
						<label for="alpha_custom_tab_title_1st"><?php esc_html_e( 'Tab Content', 'pandastore-core' ); ?></label>
						<?php
						$settings    = array(
				...
				<div class="options_group" style="padding-bottom: 9px !important">
					...
					?>
					<div class="form-field alpha_custom_tab_content_field">
						<label for="alpha_custom_tab_title_2nd"><?php esc_html_e( 'Tab Content', 'pandastore-core' ); ?></label>
						<?php
						$settings    = array(
				...
				<div class="toolbar clear">
					<button type="button" class="button-primary save_alpha_product_desc"><?php esc_html_e( 'Save tabs', 'pandastore-core' ); ?></button>
				</div>
			</div>
			<?php
		}
		...
		public function enqueue_scripts() {
			wp_enqueue_media();
			wp_enqueue_script( 'alpha-product-custom-tab', alpha_core_framework_uri( '/addons/product-custom-tab/product-custom-tab-admin' . ALPHA_JS_SUFFIX ), array(), ALPHA_VERSION, true );
			wp_localize_script(
