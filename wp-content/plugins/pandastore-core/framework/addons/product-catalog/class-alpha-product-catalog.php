	...
	class Alpha_Product_Catalog extends Alpha_Base {
		...
		public function add_catalog_customize_fields( $fields ) {
			$fields['cs_catalog_mode'] = array(
				...
				'type'     => 'custom',
				'label'    => '',
				'default'  => '<h3 class="options-custom-title">' . esc_html__( 'Theme', 'pandastore-core' ) . '</h3>',
				'priority' => '0',
			);
			...
			$fields['catalog_mode'] = array(
				'section'     => 'woocommerce_product_catalog',
				'type'        => 'toggle',
				'label'       => esc_html__( 'Enable Catalog Mode', 'pandastore-core' ),
				'description' => esc_html__( 'Catalog mode is generally used to hide some product fields such as product price and add to cart button on shop and product detail page.', 'pandastore-core' ),
				'priority'    => '0',
			);
			...
			$fields['catalog_price'] = array(
				'section'         => 'woocommerce_product_catalog',
				'type'            => 'toggle',
				'label'           => esc_html__( 'Show Price', 'pandastore-core' ),
			...
			$fields['catalog_cart'] = array(
				'section'         => 'woocommerce_product_catalog',
				'type'            => 'toggle',
				'label'           => esc_html__( 'Show Add to Cart Button', 'pandastore-core' ),
				'active_callback' => array(
					array(
						'setting'  => 'catalog_mode',
						'operator' => '==',
			...
			$fields['catalog_review'] = array(
				'section'         => 'woocommerce_product_catalog',
				'type'            => 'toggle',
				'label'           => esc_html__( 'Show Product Review', 'pandastore-core' ),
				'active_callback' => array(
					array(
						'setting'  => 'catalog_mode',
						'operator' => '==',
			...
			$fields['cs_woocommerce_catalog_mode'] = array(
				...
				'type'     => 'custom',
				'label'    => '',
				'default'  => '<h3 class="options-custom-title">' . esc_html__( 'Woocommerce', 'pandastore-core' ) . '</h3>',
				'priority' => '0',
			);
