...
if ( ! class_exists( 'Alpha_MiniCart_Quantity_Input' ) ) {
	class Alpha_MiniCart_Quantity_Input extends Alpha_Base {
		...
		public function enqueue_scripts() {
			wp_enqueue_style( 'alpha-minicart-quantity-input', alpha_core_framework_uri( '/addons/minicart-quantity-input/minicart-quantity-input.min.css' ), null, ALPHA_CORE_VERSION, 'all' );
			wp_enqueue_script( 'alpha-minicart-quantity-input', alpha_core_framework_uri( '/addons/minicart-quantity-input/minicart-quantity-input' . ALPHA_JS_SUFFIX ), array( 'alpha-framework-async' ), ALPHA_CORE_VERSION, true );
		}
