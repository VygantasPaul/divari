		...
		public function get_comments_pagination_html() {
			...
			$args = apply_filters(
				...
				array(
					...
					'end_size'  => 1,
					'mid_size'  => 2,
					'prev_text' => '<i class="' . ALPHA_ICON_PREFIX . '-icon-arrow-long-left"></i> ' . esc_html__( 'Prev', 'pandastore-core' ),
					'next_text' => esc_html__( 'Next', 'pandastore-core' ) . ' <i class="' . ALPHA_ICON_PREFIX . '-icon-arrow-long-right"></i>',
				)
			);
