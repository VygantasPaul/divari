...
if ( has_nav_menu( 'lang-switcher' ) ) {
	...
	<ul class="menu switcher lang-switcher">
		<li class="menu-item-has-children">
			<a href="#" class="switcher-toggle"><i class="flag flag-us"></i><?php esc_html_e( 'ENG', 'pandastore-core' ); ?></a>
			<ul>
				<li><a href="#"><i class="flag flag-us"></i><?php esc_html_e( 'ENG', 'pandastore-core' ); ?></a></li>
				<li><a href="#"><i class="flag flag-fr"></i><?php esc_html_e( 'FRA', 'pandastore-core' ); ?></a></li>
			</ul>
		</li>
	</ul>
	<?php
