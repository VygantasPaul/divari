...
if ( has_nav_menu( 'cur-switcher' ) ) {
	...
	<ul class="menu switcher cur-switcher">
		<li class="menu-item-has-children">
			<a class="switcher-toggle" href="#"><?php esc_html_e( 'USD', 'pandastore-core' ); ?></a>
			<ul>
				<li><a href="#"><?php esc_html_e( 'EUR', 'pandastore-core' ); ?></a></li>
				<li><a href="#"><?php esc_html_e( 'USD', 'pandastore-core' ); ?></a></li>
			</ul>
		</li>
	</ul>
	<?php
