...
class Alpha_Shop_Sort_Elementor_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Shop Sort', 'pandastore-core' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'label_color',
				array(
					'label'     => esc_html__( 'Label Color', 'pandastore-core' ),
		...
		$this->start_controls_section(
			'section_sort_select',
			array(
				'label' => esc_html__( 'Select', 'pandastore-core' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
			...
			$this->add_control(
				'select_color',
				array(
					'label'     => esc_html__( 'Select Color', 'pandastore-core' ),
					'type'      => Controls_Manager::COLOR,
					'selectors' => array(
			...
			$this->add_group_control(
				...
				array(
					...
					'label'    => esc_html__( 'Select Typography', 'pandastore-core' ),
			...
			$this->add_responsive_control(
				'select_padding',
				array(
					'label'      => esc_html__( 'Select Padding', 'pandastore-core' ),
			...
			$this->add_control(
				...
				array(
					...
					'description' => esc_html__( 'Space between label and select', 'pandastore-core' ),
				)
			);
