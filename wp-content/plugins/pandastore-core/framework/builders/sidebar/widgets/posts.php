...
class Alpha_Posts_Sidebar_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_ops = array(
			...
			'description' => esc_html__( 'Display widget typed posts.', 'pandastore-core' ),
		);

		$control_ops = array( 'id_base' => 'posts-widget' );

		parent::__construct( 'posts-widget', ALPHA_DISPLAY_NAME . esc_html__( ' - Posts', 'pandastore-core' ), $widget_ops, $control_ops );
	}
