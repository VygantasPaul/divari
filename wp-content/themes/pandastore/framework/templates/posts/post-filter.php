...
echo '<ul class="nav-filters filter-underline post-filters mb-4" data-target=".posts">
    <li><a href="' . esc_url( $blog_url ) . '" class="nav-filter post-filter' . ( $cur_cat ? '' : ' active' ) . '" data-filter="*">' . esc_html__( 'All Blog Posts', 'pandastore' ) . '<span>' . (int) $count_posts . '</span></a></li>';
