		...
		<div class="author-header">
			<div class="author-meta">
				...
				<span class="author-date">
					<?php echo apply_filters( 'alpha_filter_author_date_pattern', esc_html( get_the_author_meta( 'user_registered' ) ) ); ?>
				</span>
			</div>
			<a class="author-link" href="<?php echo esc_url( $author_link ); ?>">
				<?php printf( esc_html__( 'View all posts by %s', 'pandastore' ), esc_html( $author_name ) ); ?>
