...
<div class="login-popup" id="customer_login">
	...
	<div class="tab tab-nav-simple tab-nav-boxed form-tab">
		<ul class="nav nav-tabs nav-fill" role="tablist">
			<li class="nav-item">
				<a href="signin" class="nav-link active" data-toggle="tab"><?php esc_html_e( 'Sign In', 'pandastore' ); ?></a>
			</li>
		<?php if ( 'yes' == get_option( 'woocommerce_enable_myaccount_registration' ) ) : ?>
			<li class="nav-item">
				<a href="signup" class="nav-link" data-toggle="tab"><?php esc_html_e( 'Sign Up', 'pandastore' ); ?></a>
			</li>
		<?php endif; ?>
		</ul>
			...
			<div class="tab-pane active" id="signin">
				<form class="woocommerce-form woocommerce-form-login login" method="post">
					...
					<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
						<label for="username"><?php esc_html_e( 'Username or email address', 'pandastore' ); ?>&nbsp;<span class="required">*</span></label>
					...
					<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
						<label for="password"><?php esc_html_e( 'Password', 'pandastore' ); ?>&nbsp;<span class="required">*</span></label>
					...
					<button type="submit" class="woocommerce-button button woocommerce-form-login__submit" name="login" value="<?php esc_attr_e( 'Sign In', 'pandastore' ); ?>"><?php esc_html_e( 'Sign In', 'pandastore' ); ?></button>
			...
			<div class="tab-pane" id="signup">
				<form method="post" class="woocommerce-form woocommerce-form-login register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
					...
					<?php if ( 'no' == get_option( 'woocommerce_registration_generate_username' ) ) : ?>
						...
						<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
							<label for="reg_username"><?php esc_html_e( 'Username', 'pandastore' ); ?>&nbsp;<span class="required">*</span></label>
					...
					<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
						<label for="reg_email"><?php esc_html_e( 'Your Email address', 'pandastore' ); ?>&nbsp;<span class="required">*</span></label>
					...
					<?php if ( 'no' == get_option( 'woocommerce_registration_generate_password' ) ) : ?>
						...
						<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
							<label for="reg_password"><?php esc_html_e( 'Password', 'pandastore' ); ?>&nbsp;<span class="required">*</span></label>
					...
					$text = sprintf( esc_html__( '%1$sI agree to the %2$s', 'pandastore' ), '<p class="custom-checkbox"><input type="checkbox" id="register-policy" required="" class="mr-2"><label for="register-policy">', '[privacy_policy]</label></p>' );
					echo wpautop( wc_replace_policy_page_link_placeholders( $text ) );
					?>

					<?php wp_nonce_field( 'woocommerce-register', 'woocommerce-register-nonce' ); ?>
					<button type="submit" class="woocommerce-Button woocommerce-button button woocommerce-form-register__submit" name="register" value="<?php esc_attr_e( 'Sign Up', 'pandastore' ); ?>"><?php esc_html_e( 'Sign Up', 'pandastore' ); ?></button>
