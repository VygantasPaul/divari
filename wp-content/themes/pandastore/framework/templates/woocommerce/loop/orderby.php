...
<div class="sticky-toolbox sticky-content fix-top toolbox toolbox-top">
	<div class="toolbox-left">
		...
		if ( $toggle_class ) :
			...
			?>
			<a href="#" class="toolbox-item toolbox-toggle <?php echo esc_attr( $toggle_class ); ?> btn btn-sm btn-outline btn-primary btn-icon-left"><i class="<?php echo ALPHA_ICON_PREFIX; ?>-icon-category"></i><span class="d-none d-sm-block"><?php esc_html_e( 'Filters', 'pandastore' ); ?></span></a>
		<?php endif; ?>
<?php endif; ?>

		<form class="woocommerce-ordering toolbox-item toolbox-sort select-box" method="get">
			<?php if ( ! $ts ) : ?>
			<label><?php esc_html_e( 'Sort By:', 'pandastore' ); ?></label>
			<?php endif; ?>
			<select name="orderby" class="orderby form-control" aria-label="<?php esc_attr_e( 'Shop order', 'pandastore' ); ?>">
...
<?php if ( $ts ) : ?>
	<div class="select-items">
		<a href="<?php echo esc_url( $link ); ?>" class="filter-clean text-primary"><?php esc_html_e( 'Clean All', 'pandastore' ); ?></a>
	</div>
	<?php
endif;
