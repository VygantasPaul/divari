...
$icon_class    = alpha_get_option( 'share_type' );
$icon_class   .= alpha_get_option( 'share_use_hover' ) ? '' : ' use-hover';
...
<div class="yith-wcwl-share">
	...
	<div class="social-icons">
		...
		if ( $share_twitter_enabled ) {
			...
			<a target="_blank" class="social-icon <?php echo esc_attr( $icon_class ); ?> social-twitter"
				...
				title="<?php esc_attr_e( 'Twitter', 'pandastore' ); ?>">
				<?php echo alpha_strip_script_tags( $share_twitter_icon ? $share_twitter_icon : esc_html__( 'Twitter', 'pandastore' ) ); ?>
			</a>
			<?php
		}
		...
		if ( $share_pinterest_enabled ) {
			...
			<a target="_blank" class="social-icon <?php echo esc_attr( $icon_class ); ?> social-pinterest"
				href="<?php echo esc_url( $link ? $link : '#' ); ?>"
				title="<?php esc_attr_e( 'Pinterest', 'pandastore' ); ?>" onclick="window.open(this.href); return false;">
				<?php echo alpha_strip_script_tags( $share_pinterest_icon ? $share_pinterest_icon : esc_html__( 'Pinterest', 'pandastore' ) ); ?>
			</a>
			<?php
		}
		...
		if ( $share_email_enabled ) {
			...
			<a class="social-icon <?php echo esc_attr( $icon_class ); ?> social-email"
				...
				title="<?php esc_attr_e( 'Email', 'pandastore' ); ?>">
				<?php echo alpha_strip_script_tags( $share_email_icon ? $share_email_icon : esc_html__( 'Email', 'pandastore' ) ); ?>
			</a>
			<?php
		}
		...
		if ( $share_whatsapp_enabled ) {
			...
			<a class="social-icon <?php echo esc_attr( $icon_class ); ?> social-whatsapp"
				...
				target="_blank" title="<?php esc_attr_e( 'WhatsApp', 'pandastore' ); ?>">
				<?php echo alpha_strip_script_tags( $share_whatsapp_icon ? $share_whatsapp_icon : esc_html__( 'Whatsapp', 'pandastore' ) ); ?>
			</a>
			<?php
		}
		?>
	...
	<?php if ( $share_url_enabled ) : ?>
		<div class="yith-wcwl-after-share-section">
			...
			<?php echo ( ! empty( $share_link_url ) ) ? sprintf( '<small>%s <span class="copy-trigger">%s</span> %s</small>', esc_html__( '(Now', 'pandastore' ), esc_html__( 'copy', 'pandastore' ), esc_html__( 'this wishlist link and share it anywhere)', 'pandastore' ) ) : ''; ?>
		</div>
	<?php endif; ?>
