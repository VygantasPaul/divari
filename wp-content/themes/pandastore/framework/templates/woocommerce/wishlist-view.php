				...
				<tr id="yith-wcwl-row-<?php echo esc_attr( $item->get_product_id() ); ?>" data-row-id="<?php echo esc_attr( $item->get_product_id() ); ?>">
					...
					<td class="product-thumbnail">
						...
						<?php if ( $show_remove_product ) : ?>
							<a href="<?php echo esc_url( add_query_arg( 'remove_from_wishlist', $item->get_product_id() ) ); ?>" class="remove remove_from_wishlist fas fa-times" title="<?php echo apply_filters( 'yith_wcwl_remove_product_wishlist_message_title', esc_attr__( 'Remove this product', 'pandastore' ) ); ?>"></a>
						<?php endif; ?>
					</td>
						...
						<td class="product-add-to-cart">
							<div class="d-lg-flex">
								...
								if ( ! is_array( $show_info ) || in_array( 'quickview', $show_info ) ) {
									echo '<button class="btn btn-quickview btn-outline btn-default btn-rounded btn-sm mr-lg-2" data-mfp-src="' . esc_url( alpha_get_product_featured_image_src( $product ) ) . '" data-product="' . $product->get_id() . '" title="' . esc_attr__( 'Quick View', 'pandastore' ) . '">' . esc_html__( 'Quick View', 'pandastore' ) . '</button>';
								}
								?>
