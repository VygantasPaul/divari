...
<aside class="<?php echo esc_attr( implode( ' ', apply_filters( 'alpha_sidebar_classes', $sidebar_class ) ) ); ?>"
    id="<?php echo esc_attr( $sidebar ); ?>">
    ...
    <div class="sidebar-content">
        <?php do_action( 'alpha_sidebar_content_start' ); ?>
        ...
        <?php do_action( 'alpha_sidebar_content_end' ); ?>
