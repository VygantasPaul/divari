<?php
/**
 * Alpha Product Category Ellipse Functions
 *
 * Functions used to display ellipse type.
 *
 * @author     D-THEMES
 * @package    WP Alpha
 * @subpackage Theme
...
// Category Thumbnail
add_action( 'woocommerce_before_subcategory_title', 'alpha_pc_ellipse_before_subcategory_thumbnail', 5 );
add_action( 'woocommerce_before_subcategory_title', 'alpha_pc_ellipse_after_subcategory_thumbnail', 15 );
add_action( 'woocommerce_before_subcategory_title', 'alpha_pc_ellipse_subcategory_thumbnail' );

// Category Content
add_action( 'woocommerce_after_subcategory_title', 'alpha_pc_ellipse_after_subcategory_title' );
add_action( 'woocommerce_shop_loop_subcategory_title', 'alpha_pc_ellipse_template_loop_category_title' );

/**
 * pc_ellipse_before_subcategory_thumbnail
 *
 ...
 * @since 1.0
 */
if ( ! function_exists( 'alpha_pc_ellipse_before_subcategory_thumbnail' ) ) {
	function alpha_pc_ellipse_before_subcategory_thumbnail( $category ) {
		if ( 'ellipse' != alpha_wc_get_loop_prop( 'category_type' ) ) {
			return;
		}
...
/**
 * pc_ellipse_subcategory_thumbnail
 *
 ...
 * @since 1.0
 */
if ( ! function_exists( 'alpha_pc_ellipse_subcategory_thumbnail' ) ) {
	function alpha_pc_ellipse_subcategory_thumbnail( $category ) {
		if ( 'ellipse' != alpha_wc_get_loop_prop( 'category_type' ) ) {
			return;
		}
...
/**
 * pc_ellipse_after_subcategory_thumbnail
 *
 * Render html after subcategory thumbnail.
 *
 * @param string $category
 * @since 1.0
 */
if ( ! function_exists( 'alpha_pc_ellipse_after_subcategory_thumbnail' ) ) {
	function alpha_pc_ellipse_after_subcategory_thumbnail( $category ) {
		if ( 'ellipse' != alpha_wc_get_loop_prop( 'category_type' ) ) {
			return;
		}
 ...
 * @since 1.0
 */
if ( ! function_exists( 'alpha_pc_ellipse_template_loop_category_title' ) ) {
	function alpha_pc_ellipse_template_loop_category_title( $category ) {
		if ( 'ellipse' != alpha_wc_get_loop_prop( 'category_type' ) ) {
			return;
		}
...
/**
 * pc_ellipse_after_subcategory_title
 *
 * Render html after subcategory title.
 *
 * @since 1.0
 */
if ( ! function_exists( 'alpha_pc_ellipse_after_subcategory_title' ) ) {
	function alpha_pc_ellipse_after_subcategory_title() {
		if ( 'ellipse' == alpha_wc_get_loop_prop( 'category_type' ) ) {
			echo '</div>';
		}
	}
