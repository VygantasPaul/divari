...
(function (api, wp, $) {
    ...
    $(document).ready(function () {
        ...
        $(document.body).on('click', function (e) {
            $('.tooltip-trigger').not($(e.target).closest('.tooltip-wrapper').children('.tooltip-trigger')).siblings('.tooltip-content').addClass('hidden');
        });
        ...
        function initNavigator() {
            ...
            $('#customize-save-button-wrapper .save').on('click', function () {
                ...
                $.ajax({
                    url: alpha_customizer_vars.ajax_url,
                    data: { wp_customize: 'on', action: 'alpha_save_customize_nav', nonce: alpha_customizer_vars.nonce, navs: navs },
                    type: 'post',
                    dataType: 'json',
                    success: function (response) {
                    }
