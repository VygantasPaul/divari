...
<div class="alpha-info-section">
	<div class="alpha-section-left alpha-info">
		<div class="alpha-status-wrapper">
			<h3 class="alpha-section-title"><?php echo esc_html__( 'System Info', 'pandastore' ); ?></h3>
				...
				<?php else : ?>
					...
					<li>
						...
						<?php else : ?>
							<span class="desc">(<?php echo esc_html( $data['max_input_vars'] ); ?>)</span>
							<?php /* translators: opening and closing strong tag */ ?>
							<p class="status-notice status-error"><?php printf( esc_html__( 'Minimum %1$s2000%2$s is required', 'pandastore' ), '<strong>', '</strong>' ); ?></p>
						<?php endif; ?>
					</li>
	...
	<div class="alpha-section-right">
		<div class="alpha-changelog-section">
			<h3 class="alpha-section-title"><?php echo esc_html__( 'Change log', 'pandastore' ); ?></h3>
...
<div class="alpha-others-section">
	<h3 class="alpha-section-title"><?php echo esc_html__( 'Made by Us', 'pandastore' ); ?></h3>
	<div class="swiper nav-top">
		<div class="swiper-container">
			<div class="alpha-products swiper-wrapper">
				...
				<span class="swiper-button-prev"><i class="<?php echo ALPHA_ICON_PREFIX . '-icon-arrow-long-left'; ?>"></i></span>
				<span class="swiper-button-next"><i class="<?php echo ALPHA_ICON_PREFIX . '-icon-arrow-long-right'; ?>"></i></span>
		</div>
	</div>
</div>
