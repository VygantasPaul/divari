							...
							<div class="cart-actions mb-10">
								<div>
									<div class="cart-title-flex">
										<div>
										<h3 class="cart-title"><?php esc_html_e('Cart Totals', 'pandastore'); ?> <span class="without-delivery"><?php esc_html_e('without delivery', 'pandastore'); ?></h3> </span>
										</div>
									...
									<div class="flex-box">
										...
										<a href="<?php echo esc_url(wc_get_checkout_url()); ?>" class=" btn  btn-dim btn-border-thin mb-4  btn-icon-right  alt wc-forward">
